...
import { PrintTestDataTable } from './../PrintTestDataTable/PrintTestDataTable';

// SettlementFormsDataTable por SettlementFormsList
export const SettlementFormsDataTableCopy = () => {
  let settlementData = {
        ...
        <BodyContainer>
          <CacheProvider value={muiCache}>
            <ThemeProvider theme={getThemeForMUIDataTable()}>
              <MUIDataTable
                title={'TEST LISTA DE VIAJES'} //LISTA PLANILLAS DE LIQUIDACION
                data={filteredDataByUserRole} // data
                columns={filteredColumnsByUserRole} // columns
                options={options}
                // sx={{
                //   '@media print': {
                //     // '.MuiDataGrid-main': { color: 'rgba(226, 28, 28, 0.87)' },
                //     backgroundColor: 'transparent',
                //     color: '#000',
                //     margin: '300px 150px 300px 150px',
                //   },
                // }}
              />
            </ThemeProvider>
