...
// OPCION HIBRIDA: TextPriceStyle y TotalPriceStyle no necesitan estilos:
...
//Decuentos:
export const TextTotalAmountDiscounts = styled.div`
  grid-area: TextTotalAmountDiscounts;
  text-align: right;
  font-size: larger;
  font-weight: bold;
  padding-right: 10px;
...
export const TotalAmountDiscounts = styled.div`
  grid-area: TotalAmountDiscounts;
  font-size: larger;
  font-weight: bold;
`;
